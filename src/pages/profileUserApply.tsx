...
import UserProfileAppliedForm from './Form/formUserApply';
...
const UserProfileApply = () => {
  ...
  useEffect(() => {
    const obtenerPerfil = async (): Promise<void> => {
      try {
        const response = await fetch(`${API_LOCAL}/g-user-applied-information/${id}`, {
          method: 'GET',
        ...
        if (result.data) {
          setUser(result.data); // Asignamos los pacientes al estado
        } else {
    ...
    <div className="flex  min-h-screen">
      <div className="container mx-auto   max-w-7xl text-center">
        ...
        <div className="grid gap-8">
          <UserProfileAppliedForm user={user} />
...
export default UserProfileApply;
