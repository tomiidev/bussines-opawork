...
import { faListCheck, faUser, faUserAlt, faUserCircle } from '@fortawesome/free-solid-svg-icons';
...
const DropdownUser = () => {
  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      {dropdownOpen && (
        <div
          className={`absolute right-0 mt-4 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark text-gray-500 dark:bg-boxdark z-1`}
        >
